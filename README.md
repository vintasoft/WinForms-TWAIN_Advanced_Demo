...
## Screenshot
<img src="vintasoft-twain-advanced-demo.png" alt="VintaSoft TWAIN Advanced Demo">
...
3. Build the project ("TwainAdvancedDemo.Net7.csproj" file) in Visual Studio or using .NET CLI:
   ```
   dotnet build TwainAdvancedDemo.Net7.csproj
   ```
