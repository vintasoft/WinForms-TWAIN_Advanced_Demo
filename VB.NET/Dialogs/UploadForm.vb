...
Public Partial Class UploadForm
	...
	''' <param name="e"></param>
    Private Sub ftpUploadButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ftpUploadButton.Click
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
    Private Sub ftpUploadCancelButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles ftpUploadCancelButton.Click
        _ftpUpload.Abort()
    End Sub
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
    Private Sub httpUploadButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles httpUploadButton.Click
        Dim mainForm As MainForm
        mainForm = TryCast(Owner, MainForm)
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
    Private Sub httpUploadCancelButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles httpUploadCancelButton.Click
        _httpUpload.Abort()
    End Sub
