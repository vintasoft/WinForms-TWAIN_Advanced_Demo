...
Public Partial Class DevCapsForm
	...
	''' <param name="e"></param>
    Private Sub DevCapsForm_Load(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Load
        Try
            _device.Open()
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
    Private Sub DevCapsForm_FormClosing(ByVal sender As Object, ByVal e As FormClosingEventArgs) Handles MyBase.FormClosing
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
    Private Sub supportedCapabilitiesListBox_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles supportedCapabilitiesListBox.SelectedIndexChanged
	...
	''' <param name="sender"></param>
	''' <param name="e"></param>
    Private Sub getMethodComboBox_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles getMethodComboBox.SelectedIndexChanged
        Cursor = Cursors.WaitCursor
