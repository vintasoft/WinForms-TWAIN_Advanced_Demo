...
#Region "Methods"
    ...
    ''' Form is resized.
    ''' </summary>
    Private Sub ImageProcessingForm_Resize(ByVal sender As Object, ByVal e As EventArgs) Handles MyBase.Resize
        If stretchImageCheckBox.Checked Then
            pictureBox1.Size = New Size(pictureBoxPanel.Size.Width - 2, pictureBoxPanel.Size.Height - 2)
        End If
    End Sub
    ...
    ''' </summary>
    Private Sub commandsComboBox_SelectedIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles commandsComboBox.SelectedIndexChanged
    ...
    ''' </summary>
    Private Sub runCommandButton_Click(ByVal sender As Object, ByVal e As EventArgs) Handles runCommandButton.Click
        SyncLock _image
    ...
    ''' Form is closing.
    ''' </summary>
    Private Sub ImageProcessingForm_FormClosing(ByVal sender As System.Object, ByVal e As System.Windows.Forms.FormClosingEventArgs) Handles MyBase.FormClosing
        If pictureBox1.Image IsNot Nothing Then
            pictureBox1.Image.Dispose()
            pictureBox1.Image = Nothing
        End If
