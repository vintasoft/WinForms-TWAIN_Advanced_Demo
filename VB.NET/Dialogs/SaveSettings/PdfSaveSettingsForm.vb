...
#Region "Methods"
    ...
    Private Sub EnableJpegCompressionQuality(ByVal sender As Object, ByVal e As EventArgs) Handles jpegCompressionRadioButton.CheckedChanged, autoCompressionRadioButton.CheckedChanged
        gbJpegCompression.Enabled = True
    End Sub

    Private Sub DisableJpegCompressionQuality(ByVal sender As Object, ByVal e As EventArgs) Handles zipCompressionRadioButton.CheckedChanged, noneCompressionRadioButton.CheckedChanged, lzwCompressionRadioButton.CheckedChanged, ccittCompressionRadioButton.CheckedChanged
